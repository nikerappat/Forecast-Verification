...
![Scatter plot for Angermünde showing resulting metrics](ForecastVerification/plots/correlation_metrics_Angermünde.png)
...
![Scatter plot Station Height vs. Temperature Forecast RMSE low stations](ForecastVerification/plots/height_rmse_low.png)
![Scatter plot Station Height vs. Temperature Forecast RMSE mid stations](ForecastVerification/plots/height_rmse_mid.png)
![Scatter plot Station Height vs. Temperature Forecast RMSE elevated stations](ForecastVerification/plots/height_rmse_elevated.png)
![Scatter plot Station Height vs. Temperature Forecast RMSE high stations](ForecastVerification/plots/height_rmse_high.png)
